...
Estadistica::Estadistica()
{
    ...
    valorMin = 0;
    valorMax = 0;
    valorMasRepetidoIntensidadPromedio = 0;
    desviacionEstandar=0;
    valorRojoMasRepetido = 0;
    valorVerdeMasRepetido = 0;
    valorAzulMasRepetido = 0;
    valorMasRepetido=0;
    vecesValorMin = 0;
    vecesValorMax = 0;
    vecesValorMasRepetidoIntensidadPromedio = 0;
    vecesValorRojoMasRepetido = 0;
    vecesValorVerdeMasRepetido = 0;
    vecesValorAzulMasRepetido = 0;
    vecesValorMasRepetido = 0;
}
