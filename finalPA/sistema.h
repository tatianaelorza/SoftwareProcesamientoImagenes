...
class Sistema{
    ...
    private:
        ...
        bool bMenu = true,
        /**
         * @brief bDirectorio se utiliza como bandera para detectar la entrada de valores incorrectos en las opciones
         * de directorio.
         */
        bDirectorio = true,
        /**
         * @brief bLUT se utilizar como bandera para poder detectar la entrada de valores incorrectos de opciones
         * de directorio de tabla de conversiones.
         */
        bLUT = true,
        /**
         * @brief bImagen se ultilza como bandera para poder detectar la entrada de valores incorrectos de las opciones
         * de imagenes de un directorio.
         */
        bImagen = true;
